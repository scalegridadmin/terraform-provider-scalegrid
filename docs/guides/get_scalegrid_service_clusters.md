---
page_title: "get_scalegrid_service_clusters"
description: |-
  Get Services
---
...
See the [`scalegrid_operation` data source documentation](../data-sources/operation#get_scalegrid_service_clusters) for the full reference.
